...
Source0  : https://files.pythonhosted.org/packages/30/ec/7e53e6b1f0737976e942fc1f7c42e97f9906b79522983f49f90f44c72fa7/pyrate_limiter-3.6.1.tar.gz
...
%prep
%setup -q -n pyrate_limiter-3.6.1
cd %{_builddir}/pyrate_limiter-3.6.1
pushd ..
cp -a pyrate_limiter-3.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714519853
