...
Version  : 3.4.1
Release  : 11
URL      : https://files.pythonhosted.org/packages/24/16/9860cc2b8f1a53cf9fb1e12b46d7f6dc7563b092439066fd3bc915646bec/pyrate_limiter-3.4.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/24/16/9860cc2b8f1a53cf9fb1e12b46d7f6dc7563b092439066fd3bc915646bec/pyrate_limiter-3.4.1.tar.gz
...
%prep
%setup -q -n pyrate_limiter-3.4.1
cd %{_builddir}/pyrate_limiter-3.4.1
pushd ..
cp -a pyrate_limiter-3.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710202527
